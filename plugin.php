...
function cas_environment_check() {
	$required_params = array(
		'/home/yourls_fordham/fordh.am/includes/CAS-1.3.4/CAS.php', // path to phpCAS loader file (CAS.php)
		'https://loginp.fordham.edu', // full hostname of your CAS server
		'/cas/login', // context of the CAS server (webapp subdirectory)
		'/home/yourls_fordham/fordh.am/user/plugins/yourls-cas-plugin-1.0/cas.pem', // path to a .pem file containing 1 or more CA certs
	);
